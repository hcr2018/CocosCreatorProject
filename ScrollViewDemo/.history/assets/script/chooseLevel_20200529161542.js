    ...
    onLoad () {
       ...
       /*  this.m_animation.scaleToHidePlayEnd = function(){
        ...
        function onTouchDown (event) {
          ...
          cc.audioEngine.play(self.buttonAudio, false, 1);
        ...
        this.m_comfirm.node.on('touchstart', onTouchDown, this.node);
        this.m_comfirm.node.on('touchend', onTouchUp, this.node);
        this.m_comfirm.node.on('touchcancel', onTouchUp, this.node);
